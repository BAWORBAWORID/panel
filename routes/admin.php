...
use Pterodactyl\Http\Middleware\Admin\Servers\RestrictHiddenServerAccess;
...
Route::group(['prefix' => 'servers'], function () {
    ...
    Route::group([
        'prefix' => '/view/{server:id}',
    ], function () {
        Route::get('/', [Admin\Servers\ServerViewController::class, 'index'])->name('admin.servers.view');

        Route::group(['middleware' => [ServerInstalled::class]], function () {
            Route::get('/details', [Admin\Servers\ServerViewController::class, 'details'])
                ->name('admin.servers.view.details')
                ->middleware(RestrictHiddenServerAccess::class);
                
            Route::get('/build', [Admin\Servers\ServerViewController::class, 'build'])->name('admin.servers.view.build');
            Route::get('/startup', [Admin\Servers\ServerViewController::class, 'startup'])->name('admin.servers.view.startup');
            Route::get('/database', [Admin\Servers\ServerViewController::class, 'database'])->name('admin.servers.view.database');
            Route::get('/mounts', [Admin\Servers\ServerViewController::class, 'mounts'])->name('admin.servers.view.mounts');
        });

        Route::get('/manage', [Admin\Servers\ServerViewController::class, 'manage'])->name('admin.servers.view.manage');
        Route::get('/delete', [Admin\Servers\ServerViewController::class, 'delete'])->name('admin.servers.view.delete');

        Route::post('/build', [Admin\ServersController::class, 'updateBuild']);
        Route::post('/startup', [Admin\ServersController::class, 'saveStartup']);
        Route::post('/database', [Admin\ServersController::class, 'newDatabase']);
        Route::post('/mounts', [Admin\ServersController::class, 'addMount'])->name('admin.servers.view.mounts.store');
        Route::post('/manage/toggle', [Admin\ServersController::class, 'toggleInstall'])->name('admin.servers.view.manage.toggle');
        Route::post('/manage/suspension', [Admin\ServersController::class, 'manageSuspension'])->name('admin.servers.view.manage.suspension');
        Route::post('/manage/reinstall', [Admin\ServersController::class, 'reinstallServer'])->name('admin.servers.view.manage.reinstall');
        Route::post('/manage/transfer', [Admin\Servers\ServerTransferController::class, 'transfer'])->name('admin.servers.view.manage.transfer');
        Route::post('/delete', [Admin\ServersController::class, 'delete']);
        Route::patch('/details', [Admin\ServersController::class, 'setDetails'])
            ->middleware(RestrictHiddenServerAccess::class);
            
        Route::patch('/database', [Admin\ServersController::class, 'resetDatabasePassword']);

        Route::delete('/database/{database:id}/delete', [Admin\ServersController::class, 'deleteDatabase'])->name('admin.servers.view.database.delete');
        Route::delete('/mounts/{mount:id}', [Admin\ServersController::class, 'deleteMount'])->name('admin.servers.view.mounts.delete');
    });
...
Route::group(['prefix' => 'alerts'], function () {
    Route::get('/', [Admin\AlertController::class, 'index'])->name('admin.alerts.index');
    Route::post('/', [Admin\AlertController::class, 'store'])->name('admin.alerts.store');
    Route::post('/{alert:id}/toggle', [Admin\AlertController::class, 'toggle'])->name('admin.alerts.toggle');
    Route::delete('/{alert:id}', [Admin\AlertController::class, 'destroy'])->name('admin.alerts.destroy');
});
